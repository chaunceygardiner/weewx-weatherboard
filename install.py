...
[StdReport]
    [[WeatherBoardReport]]
        ...
        [[[Extras]]]
            ...
            #
            # The title across the top of the board, and the browser tab's.
            # Without them the board shows the station's location and the
            # tab shows the board's title.  HTML entities are allowed.
            title = PaloAltoWeather.com
